<div class="row">
	<div class="col-md-12">
		<?php if($this->session->userdata('errorregistrasiidkegiatan')):?>
			<div class="alert alert-danger">
				<?=$this->session->userdata('errorregistrasiidkegiatan')?> 
			</div>			
		<?php else:?>
			<div class="alert alert-info alert-dismissable">
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
				Kode Kegiatan : <?=$this->session->userdata('registrasiidkegiatan')?> <br>
				<b>Kegiatan : <?=ucwords($kegiatan->kegiatan_nama)?></b> 
			</div>			
		<?php endif;?> 	
	    <div class="panel panel-info">
	        ...
	        <div class="panel-wrapper collapse in" aria-expanded="true">
	            <div class="panel-body">
					<form id="forminput" class="formaction" method="POST" action="javascript:void(0)" url="<?= base_url($global->url.'index/'.$this->uri->segment(4))?>"  enctype="multipart/form-data">
						<div class="row">
							<div class="col-sm-12">		
