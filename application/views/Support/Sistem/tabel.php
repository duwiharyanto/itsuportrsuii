        ...
        <div class="panel-wrapper collapse in">
          <div class="panel-body">
            <div class="alert alert-primary" role="alert">
              Update tombol kirim email otomatis
            </div>
            <div id="loadajax" style="display: none">
              <div class="alert alert-danger" role="alert">
                <span class="fa fa-refresh fa-spin"></span> Proses kirim email
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <?php tombolaksi($global,$row->trobelsistem_id,$this->uri->segment(3),$row->trobelsistem_image)?>
