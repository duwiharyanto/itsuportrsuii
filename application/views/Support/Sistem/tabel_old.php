                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <?php tombolaksi($global,$row->trobelsistem_id,$this->uri->segment(3))?>
                      </td>
                    </tr>
                  <?php $i++;?>  
                  <?php endforeach;?>
