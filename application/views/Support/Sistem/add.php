						...
						<div class="row">
							<div class="col-sm-12">		
								...
								<div class="form-group">
									...
									<input readonly required type="text" name="trobelsistem_ticket" class="form-control" title="Harus di isi" value="<?=$notiket?>">
									<p class="text-danger">Otomatis di generate sistem</p>
								</div>    
								<div class="form-group">
									<label>Trobleshoot/Error</label>
									<input required type="text" name="trobelsistem_nama" class="form-control" title="Harus di isi">
								</div>
								<div class="form-group">
									<label>Unit</label>
									<select class="form-control select" name="trobelsistem_unitid">
										<?php foreach($unit As $row):?>
											<option value="<?=$row->unit_id?>"><?=ucwords($row->unit_nama)?></option>
										<?php endforeach;?>
									</select>
								</div>								
								<div class="form-group">
									<label>Deskripsi</label>
									<textarea  required class="summernote form-control" name="trobelsistem_deskripsi" rows="8"></textarea>
								</div>
								<div class="form-group">
									<label>Berkas</label>
									<input type="file" name="trobelsistem_image">
