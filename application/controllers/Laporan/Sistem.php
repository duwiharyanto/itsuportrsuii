...
// class Registrasi extends Core {
	...
	private $default_url="Laporan/Sistem/"; //Mendefinisikan url controller
	private $default_view="Laporan/Sistem/"; //Mendefinisiakn defaul view
	...
	private function global_set($data){
		...
		if(isset($data['overwriteview'])){
			...
			$overwriteview="views/Laporan/Sistem/index.php";
			$menu_submenu=false;
		}
		$data=array(
