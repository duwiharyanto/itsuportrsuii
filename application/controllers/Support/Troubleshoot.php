...
// class Registrasi extends Core {
	...
	private $default_url="Support/Troubleshoot/"; //Mendefinisikan url controller
	private $default_view="Support/Troubleshoot/"; //Mendefinisiakn defaul view
	...
	private function global_set($data){
		...
		if(isset($data['overwriteview'])){
			...
			$overwriteview="views/Support/Troubleshoot/index.php";
			$menu_submenu=false;
		}
		$data=array(
